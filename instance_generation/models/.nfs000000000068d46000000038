...
class BlendedLatentDiffusionSDXLWithAverage(StableDiffusionXLPipeline):
    @torch.no_grad()
    def edit_image(
        self,
        init_image,
        ...
        # Fusion multi prompt
        l_caption = {"a_photo_of_red_car", "a_photo_of_blue_car", "a_photo_of_green_car", "a_photo_of_yellow_car","a_photo_of_grey_car", "a_photo_of_pink_car", "a_photo_of__car", "a_photo_of_green_car"}
        prompt_embeds_sum = 0
        pooled_prompt_embeds_sum = 0
        for pro in l_caption:
            # breakpoint()
            prompt = pro
            (
            ...
            prompt_embeds_sum += prompt_embeds
            pooled_prompt_embeds_sum += pooled_prompt_embeds
            
        # breakpoint()
        prompt_embeds_avg = prompt_embeds_sum/len(l_caption)
        pooled_prompt_embeds_avg =  pooled_prompt_embeds/len(l_caption)
        prompt_embeds = prompt_embeds_avg
        pooled_prompt_embeds = pooled_prompt_embeds_avg
